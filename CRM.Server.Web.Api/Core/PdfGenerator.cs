...
namespace PhantomJs.NetCore
{
    public class PdfGenerator
    {
         ...
         */
        public string GeneratePdf(string html, string outputFolder, string filename = "testpdf")
        {
            ...
            string htmlFileName = WriteHtmlToTempFile(html, filename);
        ...
        private string WriteHtmlToTempFile(string html, string htmlFileName)
        {
